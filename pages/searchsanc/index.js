    ...
    return (
        <div className='min-h-screen bg-mutelu_1 bg-cover'>
            ...
            <div className='container'>
                <div className='mx-[15rem] mt-[1rem]'>
                    <div className='font-bold text-center text-5xl pt-10 tracking-widest'>
                        Search sanctuary
                ...
                <div className='place-content-center'>
                    ...
                    <div className='container pt-[2rem]'>
                        <div className='flex min-w-screen place-content-center py-2 rounded-md'>
                            <input
                                id='search-box'
                                className=' w-[30rem] rounded-xl pl-3 text-xl py-2 border-royal-purple border-2'
